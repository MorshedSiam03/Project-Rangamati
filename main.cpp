...
void cover() {
    ...
    renderBitmapString(850, 949, 0.0f, GLUT_BITMAP_HELVETICA_18, "  Somewhere in Rangmati");
...
int main(int argc, char ** argv) {
    ...
    cout << "                 Somewhere in Rangmati" << endl;
    ...
    glutCreateWindow("Somewhere in Rangamati"); // Create a window with the given title
